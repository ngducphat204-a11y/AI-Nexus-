...
export const LandingHero: React.FC<LandingHeroProps> = ({
  ...
  return (
    <div className="w-full min-h-screen bg-[#080d18] text-white selection:bg-[#0ea5e9] selection:text-white overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left z-10">
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f0f9ff] via-[#38bdf8] to-[#0284c7]">
          ...
          {/* Right Column: 3D Chibi Mascot with Tech Cyan Aura */}
            ...
            <div className="lg:col-span-4 rounded-2xl bg-[#0b1220] border border-sky-500/20 p-5 flex flex-col justify-between shadow-lg">
              ...
              <div>
                <h3 className="text-xs font-bold text-sky-200/90 uppercase tracking-wider mb-4 pb-2 border-b border-sky-500/20 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-sky-400/80 font-mono">FloorScan AI</span>
                </h3>
      ...
      ═══════════════════════════════════════════════════════════════ */}
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-sky-500/15">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 rounded-2xl sm:rounded-3xl bg-[#0b1220] border border-sky-500/30 p-5 sm:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.7)]">
            ...
            <div className="flex items-center justify-between pb-4 mb-4 border-b border-sky-500/15">
              ...
              <span className="inline-flex items-center gap-1.5 text-sky-400 text-xs font-medium">
                <span className="w-2 h-2 rounded-full bg-[#0ea5e9] animate-pulse" />
            ...
            <div className="grid grid-cols-12 gap-4">
              ...
              <div className="col-span-12 sm:col-span-8 flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  {/* Sàn */}
                  <div className="p-3 rounded-xl bg-[#121929] border border-sky-500/15 flex items-center justify-between">
                    <div>
                      <div className="text-base font-bold text-white font-mono leading-none">85.2 m²</div>
                      <div className="text-[10px] text-sky-200/60 mt-1">Diện tích sàn</div>
                    </div>
                    <Layers className="w-4 h-4 text-[#38bdf8]" />
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-[#121929] border border-sky-500/15 flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-[10px] text-sky-200/60 mt-1">Chiều dài tường</div>
                    </div>
                    <Ruler className="w-4 h-4 text-[#0ea5e9]" />
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-[#121929] border border-sky-500/15 flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-[10px] text-sky-200/60 mt-1">Cửa các loại</div>
                    </div>
                    <Home className="w-4 h-4 text-[#0284c7]" />
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-[#121929] border border-sky-500/15 flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-[10px] text-sky-200/60 mt-1">Thiết bị vệ sinh</div>
                    </div>
                    <CheckCircle2 className="w-4 h-4 text-[#2563eb]" />
                  </div>
                </div>
                ...
                {/* Biểu đồ khối lượng */}
                <div className="p-3.5 rounded-xl bg-[#121929] border border-sky-500/15">
                  <div className="text-xs font-semibold text-white/90 mb-3">
                    Biểu đồ khối lượng
                  </div>

                  {/* Custom Bar Visualization in Tech Blue Palette */}
                  <div className="flex items-end justify-between gap-4 h-28 pt-2">
                    
                    {/* Bar 1: Tường 120.5m */}
                    <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                      <div className="w-full max-w-[36px] bg-[#38bdf8] rounded-t-md transition-all hover:brightness-110 shadow-sm shadow-sky-400/20" style={{ height: '90%' }} />
                      <span className="text-[9px] text-sky-200/70 font-mono">Tường</span>
                    </div>

                    {/* Bar 2: Sàn 85.2m2 */}
                    <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                      <div className="w-full max-w-[36px] bg-[#0ea5e9] rounded-t-md transition-all hover:brightness-110 shadow-sm shadow-sky-500/20" style={{ height: '65%' }} />
                      <span className="text-[9px] text-sky-200/70 font-mono">Sàn</span>
                    </div>

                    {/* Bar 3: Cửa 8 bộ */}
                    <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                      <div className="w-full max-w-[36px] bg-[#0284c7] rounded-t-md transition-all hover:brightness-110 shadow-sm shadow-blue-500/20" style={{ height: '25%' }} />
                      <span className="text-[9px] text-sky-200/70 font-mono">Cửa</span>
                    </div>

                    {/* Bar 4: Thiết bị 12 */}
                    <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                      <div className="w-full max-w-[36px] bg-[#2563eb] rounded-t-md transition-all hover:brightness-110 shadow-sm shadow-blue-600/20" style={{ height: '35%' }} />
                      <span className="text-[9px] text-sky-200/70 font-mono">Thiết bị</span>
                    </div>

                    {/* Legend list on right */}
                    <div className="flex flex-col gap-1 text-[10px] font-mono text-white/80 pl-2 border-l border-sky-500/20 shrink-0">
                      <div className="flex items-center gap-1.5">
                        <span className="w-2 h-2 rounded-xs bg-[#38bdf8]" />
                        <span>Tường: 120.5m</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="w-2 h-2 rounded-xs bg-[#0ea5e9]" />
                        <span>Sàn: 85.2m²</span>
                      </div>
                      <div className="flex items-center gap-1.5">
      ...
      {showVideoModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
          <div className="relative w-full max-w-4xl bg-[#0b1220] border border-sky-500/40 rounded-2xl overflow-hidden shadow-2xl">
            {/* Modal Top Bar */}
            <div className="flex items-center justify-between px-4 py-3 bg-[#060a14] border-b border-sky-500/20">
              <div className="flex items-center gap-2">
