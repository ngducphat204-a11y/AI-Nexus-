...
export const LandingFooter: React.FC<LandingFooterProps> = ({
  ...
  return (
    <footer className="bg-[#050a14] border-t border-sky-500/15 py-10 text-white/50 text-xs font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-6 border-b border-white/10">
          
          {/* Brand Logo */}
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-[#0284c7] via-[#0ea5e9] to-[#38bdf8] p-[1.5px] shadow-[0_2px_10px_rgba(14,165,233,0.3)]">
            ...
            <div>
              ...
              <p className="text-[11px] text-sky-200/50 font-sans">
          ...
          <div className="flex flex-wrap items-center gap-6 font-medium text-white/70">
            <a href="#hero" className="hover:text-[#38bdf8] transition-colors">Sản phẩm</a>
            <a href="#features" className="hover:text-[#38bdf8] transition-colors">Tính năng</a>
            <a href="#how-it-works" className="hover:text-[#38bdf8] transition-colors">Cách hoạt động</a>
            <a href="#clients" className="hover:text-[#38bdf8] transition-colors">Khách hàng</a>
            <button
              onClick={onGetStarted}
              className="inline-flex items-center gap-1.5 text-[#38bdf8] hover:text-white font-semibold transition-colors cursor-pointer"
            >
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-white/40">
          ...
          <div className="flex items-center gap-4">
            <span className="text-[#38bdf8] font-semibold">✓ Tiết kiệm 80% thời gian</span>
            <span>•</span>
